    ...
    return (
        <Base>
            <Container className="mt-4" >
                ...
                <Row>
                    <Col md={12}>
                        <Card className="mt-3 ps-2"  style={{ backgroundColor: 'rgb(255 255 255 / 44%)', backdropFilter: 'blur(30px)' }}>
                            {post && (
                                <CardBody>
                                    <CardText>
          ...
          >
            ...
            {post &&
              post.comments.map((c, index) => (
                <Card key={index} className="mt-4 border-0" style={{ backgroundColor: 'rgb(255 255 255 / 44%)', backdropFilter: 'blur(10px)' }}>
                  <CardBody>
                    <CardText>{c.comment}</CardText>
                  </CardBody>
                </Card>
              ))}
            <Card className="mt-4 border-0" style={{ backgroundColor: 'rgb(255 255 255 / 44%)', backdropFilter: 'blur(30px)' }}>
              <CardBody>
               <Input
                type="textarea"
