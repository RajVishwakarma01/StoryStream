...
function NewFeed() {
  ...
  return (
    <div className="container-fluid">
      ...
      <Row>
        <Col md={{ size: 12 }}>
          <h1 style={{ backgroundColor: 'rgba(0, 0, 0, 0)', backdropFilter: 'blur(15px)' }}>Story Count ({postContent.totalElements})</h1>
          ...
          <Container className='text-center mt-3'>
            <Pagination size='lg'>
              <PaginationItem disabled={postContent.pageNumber === 0}>
                <PaginationLink  style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(10px)' }} previous onClick={() => changePage(postContent.pageNumber - 1)}>
                  Previous
                </PaginationLink>
              </PaginationItem>
              ...
              {[...Array(postContent.totalPages)].map((_, index) => (
                <PaginationItem active={index === postContent.pageNumber} key={index}>
                  <PaginationLink  style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(10px)' }} onClick={() => changePage(index)}>
                    {index + 1}
                  </PaginationLink>
                </PaginationItem>
              ))}
              ...
              <PaginationItem disabled={postContent.lastPage}>
                <PaginationLink style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(10px)' }} next onClick={() => changePage(postContent.pageNumber + 1)}>
                  Next
                </PaginationLink>
              </PaginationItem>
            </Pagination>
